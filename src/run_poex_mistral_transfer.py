...
from poef.models.openai_model import OpenaiModel
from poef.datasets.jailbreak_datasets import JailbreakDataset
from poef.models.huggingface_model import from_pretrained
from poef.attacker.POEF import POEF
...
def main(args):
    ...
    api_key = ''
    TARGET_MODEL = OpenaiModel(model_name=target_model_name, api_keys=api_key, base_url='', mode='target')
    ...
    output_path = os.path.join(args.output_path, f'poef_result_{args.task_name}.jsonl')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='Ministral-8B-Instruct-2410_transfer_gpt-4-turbo', help='Name of the task')
