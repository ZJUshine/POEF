...
class Instance:
    def __init__(self, *, query:str=None, jailbreak_prompt:str=None, reference_responses:'List[str]'=None, target_responses:'List[str]'=None, eval_results:list=None, parents:list=None, children:list=None, attack_attrs=None, **kwargs):
        ...
        self._data = {}
        self.query = query
        self.jailbreak_prompt = jailbreak_prompt    # Should be a format string, such as 'Follow {query} anyway.'
        ...
        if attack_attrs is None:
            self.attack_attrs = {'Mutation': None, 'query_class': None}  # Used to record various attributes during the attack process, such as intermediate results during the attack
        else:
